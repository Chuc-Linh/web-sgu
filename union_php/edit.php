...
<form method="post" onsubmit="return validateSanPham()" class="card p-4 shadow-sm">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="hientrang" class="form-control"
    ...
    <div class="mb-3">
        ...
        <input type="number" name="giabandexuat" class="form-control" min="1"
               value="<?= $sp['giabandexuat'] ?>" required>
    </div>

    <div class="mb-3">
        <label class="form-label">% Lợi nhuận</label>
        <input type="number" step="0.1" name="phantramloinhuanmongmuon"
